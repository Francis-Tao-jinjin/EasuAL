...
export function testBpmCurve(easual:typeof EasuAL) {
  ...
  console.log('totalTicks at', t2 ,easual.context.BPM.getTicksAtTime(t2), 'should be 768', Math.round(easual.context.BPM.getTicksAtTime(t2)) === 768);
  ...
  console.log('totalTicks at', t2 + 0.5, easual.context.BPM.getTicksAtTime(t2 + 0.5), 'should be 936', Math.round(easual.context.BPM.getTicksAtTime(t2 + 0.5)) === 936);
  ...
  console.log('totalTicks at', t3, easual.context.BPM.getTicksAtTime(t3),' should be 1056', Math.round(easual.context.BPM.getTicksAtTime(t3)) === 1056);
  ...
  console.log('Finished BPM Curve test');
}